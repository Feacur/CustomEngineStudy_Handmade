...
set map=-Wl,--Map=.\%intermediate%_dll.map
set imp=-Wl,--out-implib,.\%intermediate%_dll.a
...
set compiler=-o %target_name%.dll %compiler%

echo ---- DLL  ---- %time%
gcc "%source_folder%\main.cpp" %compiler% -shared %imp%
echo ---- DONE ---- %time%
