...
inline Raytrace_Result raytrace_sphere(Sphere sphere, Ray3 ray) {
	...
	Vector3 vector_to_centre = ray.origin - sphere.centre;
	...
	float c = dot_product(vector_to_centre, vector_to_centre) - sphere.radius * sphere.radius;
	...
	result.normal = result.point - sphere.centre;
