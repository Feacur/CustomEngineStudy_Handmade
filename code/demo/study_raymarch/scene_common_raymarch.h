...
*/
inline Raymarch_Result raymarch_scene(Ray3 ray, int32 steps_limit, float depth_limit) {
	PERSISTENT_LOCAL_CONST float proximity_epsilon = 0.1f;
...
inline float raymarch_attenuation(Vector3 point, Vector3 normal, Vector3 light, int32 steps_limit, float depth_limit) {
	PERSISTENT_LOCAL_CONST float proximity_epsilon = 0.1f;
