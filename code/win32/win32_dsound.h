#define DSOUND_ENABLED true

#include <dsound.h> // obvious
...
GLOBAL_VAR Sound_Buffer sound_buffer;
...
void setup_sound_buffer(HWND window) {
	...
	sound_buffer.sound.data = (int16 *)VirtualAlloc(0, secondary_buffer_description.dwBufferBytes, MEM_RESERVE | MEM_COMMIT, PAGE_READWRITE);
